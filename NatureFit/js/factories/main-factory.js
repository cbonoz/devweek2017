...
myApp.factory('MainFactory', function($http){
  ...
  var definitions = {
        ...
        resellerFinancing: "OFD is financing the Reseller for the System which will be immediately distributed to the End User. The Reseller does not have the right to use the Oracle products and services.",
        ...
        nationalFederal: "A government for a nation or a country.",
        stateProvincial: "A government for a state or a province.",
        local: "A government for a small location or region.",
        quasiGovernment: "A private entity that acts like a government. (ex. Electric company, postal service).",
        ...
        hws1: "Hardware + Initial Period Support. Initial Period may be from 12 to 60 months.",
        ...
        linuxSupport: "Support for database customers who operate their systems on the Oracle Linux operating system.",
        oracleVM: "Oracle Virtual Machine",
        bps: "Outsourcing of a business process to a third party company. IT outsourcing is not considered BPS when done stand-alone. HR, procurement or call center support, which may include IT outsourcing, are considered BPS because it involves taking over the business process.",
        ...
        incentiveRateFinancing: "Priced below-market rate where a portion of the interest cost is subsidized by Supplier (Oracle and/or Partner) to incent Customer to acquire Oracle products and services.",
        ...
        promotions: "OFD Sales Promos are preapproved payment discounts that may be used to offer below-market rates or structures (e.g.: ramps, skips) for qualifying products.",
        abl: "ABL is an excel-based OFD pricing tool used to calculate payment solutions.",
        passThroughPayments: "Portion of the total Payment Amount that is attributable towards fees for other services that are due at the same timing as that of the funded Payment Amount (ex. fees for Future Support, OMCS).  Pass-Through payments are usually a consequence of payment structure.",
        ...
        techRefresh: "Customer upgrades to a newer generation of technology.  Includes acquisition of new hardware.",
        ...
        tradeIn: "Return of an existing equipment along with the acquisition of a new one.  Usually includes a monetary value/consideration for the return of the equipment and acquisition of the new one.",
        crossBorder: "A cross border deal occurs when programs, hardware or services are supplied or delivered to a country that is different from the country of the Oracle Order/Contracting entity.",
        ...
        purchaseOption: "An option given under a lease/right to use contract where the customer can purchase the asset at the end of original or renewal term. Purchase options are subject to local legislation and tax rules.",
        ...
        knowYourCustomer: "KYC is a practice common to regulated financial institutions verifying the identity of its clients.  It is a customer due diligence process that helps mitigate risk, prevent identity fraud, & comply with International regulations.  KYC varies according to factors such country, scope of regulation, among others.",
